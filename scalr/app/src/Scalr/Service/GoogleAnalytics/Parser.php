...
class Scalr_Service_GoogleAnalytics_Parser
{
    ...
    {
        list($domainHash, $timestamp, $sessionNumber, $campaignNumer, $campaignData) = preg_split('/[\.]/', $this->utmz);
        ...
        if($utmgclid) {
          ...
          list($domainHash, $randomId, $timeInitialVisit, $timeBeginningPreviousVisit, $timeBeginningCurrentVisit, $sessionCounter) = preg_split('/[\.]/', $this->utma);
